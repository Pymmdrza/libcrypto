...
from ..Util._file_system import libcrypto_filename
...
try:
    ...
    def load_lib(name, cdecl):
        ...
        if hasattr(ffi, "RTLD_DEEPBIND") and not os.getenv('LibCrypto_DISABLE_DEEPBIND'):
...
def load_LibCrypto_raw_lib(name, cdecl):
    """Load a shared library and return a handle to it.
    ...
    for ext in extension_suffixes:
        try:
            ...
            full_name = libcrypto_filename(dir_comps, filename)
